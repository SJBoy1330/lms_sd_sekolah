                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 DataTable no-footer" id="kt_table_materi">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-center">Tingkat</th>
                                <th class="min-w-250px text-center">Pelajaran</th>
                                <th class="min-w-150px text-center">Bab</th>
                                <th class="min-w-150px text-center">Judul</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr class="anim-2" style="opacity: 0;">
                                ...
                                <td>
                                    <p class="text-center mb-0">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum provident minus delectus vitae deserunt illum aperiam facere, dignissimos, excepturi beatae reprehenderit ipsum. Iure in autem porro pariatur molestiae, placeat unde?   
                                    </p>
                                </td>
                            </tr>
                        </tbody>
...
<div class="modal fade" id="modalDetail" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-850px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Detail Materi</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal" data-kt-users-modal-action="close" type="button">
                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                    ...
                    <div class="col-12">
                        ...
                        <label class="d-flex flex-stack mb-5 cursor-pointer">
                            ...
                            <span class="d-flex me-2">
                                ...
                                <span class="d-flex flex-column">
                                    <span class="fw-bolder fs-6">Total Dokumen</span>
                                    <span class="fs-7 text-muted">10 File</span>
                                </span>
                                <!--end:Info-->
                            </span>
                        </label>
                        ...
                        <label class="d-flex flex-stack mb-5 cursor-pointer">
                            ...
                            <span class="d-flex me-2">
                                ...
                                <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-secondary">
                                        <i class="fa-duotone fa-video" style="font-size: 1.5rem;"></i>
                                    </span>
                                </span>
                                <!--end:Icon-->
                                <!--begin:Info-->
                                <span class="d-flex flex-column">
                                    <span class="fw-bolder fs-6">Total Video</span>
                                    <span class="fs-7 text-muted">10 Video</span>
                                </span>
                                <!--end:Info-->
                            </span>
                        </label>
                        ...
                        <label class="d-flex flex-stack mb-5 cursor-pointer">
                            ...
                            <span class="d-flex me-2">
                                ...
                                <!--begin:Info-->
                                <span class="d-flex flex-column">
                                    <span class="fw-bolder fs-6">Pembuat Materi</span>
                                    <span class="fs-7 text-muted">Drs. Hendrawati Kusumaningsih Sagaru Saputri</span>
                                </span>
                                <!--end:Info-->
                            </span>
                        </label>
