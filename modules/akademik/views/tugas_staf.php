                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn btn-sm btn-light-danger me-2 " id="deleteall" style="display: none;">
                                <span class="svg-icon svg-icon-2 me-0">
                                    <i class="fa-duotone fa-ban" style="font-size: 18px;"></i>
                                </span>
                                Tolak Tugas</button>
                            <button type="button" data-bs-toggle="modal" data-bs-target="#modalInputNilai" class="btn btn-sm btn-light-warning me-2 " id="newbutton" style="display: none;">
                                <span class="svg-icon svg-icon-2 me-0">
                                    <i class="fa-duotone fa-feather" style="font-size: 18px;"></i>
                                </span>
                                Nilai Serentak</button>
                        </div>
                    </div>
                    <div class="fv-row">
...
<div class="modal fade" id="modalInputNilai" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-850px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Input Nilai Siswa</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal" data-kt-users-modal-action="close" type="button">
                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                    ...
                    <div class="col-md-12">
                        <div class="d-flex flex-column mb-8 fv-row" id="req_password_ulang">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">Input Nilai Siswa</span>
                            </label>
