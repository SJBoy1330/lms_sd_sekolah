            ...
            <div class="card-body">
                <form action="">
                    <div class="row">
                        ...
                        <div class="col-md-6 align-self-end d-flex justify-content-end" style="padding:5px;">
                        ...
                        <table class="table table-light">
                            ...
                            <thead class=" fs-7 fw-bolder">
                                ...
                                <tr class=" text-white text-uppercase gs-0 align-middle text-center">
                                    ...
                                    <th scope="col" class="  bg-danger border border-white">Metode Pembayaran</th>
                                    <th scope="col" class="  bg-danger border border-white">Status Tagihan</th>
