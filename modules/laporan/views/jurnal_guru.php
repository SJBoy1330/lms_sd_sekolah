                ...
                <form action="">
                    <div class="row">
                        <div class="col-md-4 col-xl-4" style="padding:5px;">
                            ...
                            <input class="form-select form-select-solid" type="text" name="tanggal" value="" readonly />
                        </div>
                        <div class="col-md-4 col-xl-4" style="padding:5px;">
                            <label class="filter-title mb-2">Guru</label>
                        ...
                        <table class="table table-light" id="kt_table_customers_payment">
                            ...
                            <thead class=" fs-7 fw-bolder">
                                ...
                                <tr class=" text-white text-uppercase gs-0 align-middle text-center">
                                    ...
                                    <th scope="col" rowspan="2" class=" min-w-125px bg-primary border border-white">Tanggal</th>
                                    <th scope="col" rowspan="2" class=" min-w-65px bg-primary border border-white">Hari</th>
                                    <th scope="col" rowspan="2" class=" w-auto bg-primary border border-white">Guru</th>
                                    <th scope="col" rowspan="2" class=" bg-primary border border-white">Kelas</th>
                                    <th scope="col" rowspan="2" class=" bg-primary border border-white">Pelajaran</th>
                                    <th scope="col" rowspan="2" class=" bg-primary border border-white">Materi</th>
                                    <th scope="col" rowspan="2" class=" bg-primary border border-white">Kegiatan Guru</th>
                                    <th scope="col" rowspan="2" class=" bg-primary border border-white">Kegiatan Siswa</th>
                                    <th scope="col" rowspan="2" class=" bg-primary border border-white">Kejadian Kelas</th>
                                    <th scope="col" colspan="4" class=" min-w-65px bg-primary border border-white pe-3">Kehadiran</th>
                                </tr>
                                <tr class="text-white text-uppercase gs-0 align-middle text-center">
                                    ...
                                    <th scope="col" class=" min-w-65px bg-primary border border-white pe-3">TH</th>
                                </tr>
                                <!--end::Table row-->
                            </thead>
                            <!--end::Table head-->
