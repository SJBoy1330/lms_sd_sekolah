    ...
    <div class="container-xxl" id="kt_content_container">
        ...
        <div class="row g-5 g-xl-8">
                ...
                <div class="row mb-5 mb-xl-8 g-5 g-xl-8">
                    ...
                    <div class="col-6">
                        ...
                        <div class="card card-stretch">
                            <!--begin::Link-->
                            <a href="../../demo17/dist/account/overview.html" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                    ...
                    <div class="col-6">
                        ...
                        <div class="card card-stretch">
                            <!--begin::Link-->
                            <a href="../../demo17/dist/account/referrals.html" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                    ...
                    <div class="col-6">
                        ...
                        <div class="card card-stretch">
                            <!--begin::Link-->
                            <a href="../../demo17/dist/apps/customers/view.html" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                    ...
                    <div class="col-6">
                        ...
                        <div class="card card-stretch">
                            <!--begin::Link-->
                            <a href="../../demo17/dist/apps/projects/project.html" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                    ...
                    <div class="col-6">
                        ...
                        <div class="card card-stretch">
                            <!--begin::Link-->
                            <a href="../../demo17/dist/apps/projects/users.html" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                    ...
                    <div class="col-6">
                        ...
                        <div class="card card-stretch">
                            <!--begin::Link-->
                            <a href="../../demo17/dist/apps/customers/list.html" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                    ...
                    <div class="col-6">
                        ...
                        <div class="card card-stretch">
                            ...
                            <a href="../../demo17/dist/apps/chat/private.html" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-4 fw-bolder">Messages</span>
                            </a>
                            <!--end::Link-->
                        </div>
                        <!--end::Card-->
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61bc3dda19278">
                                ...
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61bc3dda19278" data-allow-clear="true">
                                                <option></option>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="d-flex align-items-sm-center">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="<?= base_url(); ?>assets/media/svg/brand-logos/fox-hub.svg" class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                            <!--begin::Section-->
            ...
            <div class="col-xl-8 ps-xl-12">
                ...
                <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-primary mb-5 mb-xl-8" style="background-color: ;background-position: 100% 50px;background-size: 500px auto;background-image:url('<?= base_url(); ?>assets/media/misc/city.png')">
                    <!--begin::Body-->
                    <div class="card-body d-flex flex-column justify-content-center ps-lg-12">
                        ...
                        <!--begin::Action-->
                        <div class="m-0">
                            <a href='#' class="btn btn-dark fw-bold px-6 py-3" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Create a Store</a>
                        </div>
                        <!--begin::Action-->
                    </div>
                    <!--end::Body-->
                                ...
                                <div class="mt-5">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <div class="symbol symbol-50px me-3">
                                                <div class="symbol-label bg-light">
                                                    <img src="<?= base_url(); ?>assets/media/svg/brand-logos/plurk.svg" class="h-50" alt="" />
                                                </div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                    ...
                                    <div class="d-flex flex-stack mb-5">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <div class="symbol symbol-50px me-3">
                                                <div class="symbol-label bg-light">
                                                    <img src="<?= base_url(); ?>assets/media/svg/brand-logos/figma-1.svg" class="h-50" alt="" />
                                                </div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <div class="symbol symbol-50px me-3">
                                                <div class="symbol-label bg-light">
                                                    <img src="<?= base_url(); ?>assets/media/svg/brand-logos/vimeo.svg" class="h-50" alt="" />
                                                </div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-header border-0 py-5">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <!--begin::Menu 1-->
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61bc3dda1e2a7">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                            <div class="fs-5 text-dark fw-bolder">Filter Options</div>
                                        </div>
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61bc3dda1e2a7" data-allow-clear="true">
                                                        <option></option>
                                                        <option value="1">Approved</option>
                                                        <option value="2">Pending</option>
                                                        <option value="2">In Process</option>
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body p-0">
                                <!--begin::Chart-->
                                <div class="mixed-widget-12-chart card-rounded-bottom bg-primary" data-kt-color="primary" style="height: 175px"></div>
                                <!--end::Chart-->
                                <!--begin::Stats-->
