                    ...
                    <div class="card-header pt-7" id="kt_chat_contacts_header">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="tabcontent" id="personal">
                                <button type="button" class="btn btn-sm btn-light-primary ms-1 " data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">
                                    <span class="svg-icon svg-icon-1 me-0 text-center">
                                        <i class="fa-duotone fa-address-book" style="font-size: 30px;"></i>
                                    </span>
                                </button>
                            </div>
                        ...
                        <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x my-3 fs-6 w-100 ">
                            <li class="nav-item w-50">
                                <a class="nav-link active text-center " onclick="contact(event, 'personal'); chat(event, 'personalchat') " data-bs-toggle="tab" href="#kt_tab_pane_1">Personal</a>
                            </li>
                            <li class="nav-item w-50">
                                <a class="nav-link text-center " onclick="contact(event, 'grup'); chat(event, 'grupchat')" data-bs-toggle="tab" href="#kt_tab_pane_2">Grup</a>
                            </li>
                        </ul>
                    </div>
                    <!--end::Card header-->
                                ...
                                <div class="scroll-y me-n5 pe-5 h-200px h-lg-auto" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_chat_contacts_header" data-kt-scroll-wrappers="#kt_content, #kt_chat_contacts_body" data-kt-scroll-offset="5px">
                                    ...
                                    <div class="d-flex flex-stack py-4 ">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Details-->
                                            <div class="ms-5 ">
                                                <a class=" fs-5 fw-bolder text-gray-900 text-hover-primary mb-2" data-bs-toggle="tab" href="#kt_tab_pane_chat_1">Emmaaa Bold</a>
                                ...
                                <div class="scroll-y me-n5 pe-5 h-200px h-lg-auto" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_chat_contacts_header" data-kt-scroll-wrappers="#kt_content, #kt_chat_contacts_body" data-kt-scroll-offset="5px">
                                    ...
                                    <div class="d-flex flex-stack py-4 ">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Details-->
                                            <div class="ms-5 ">
                                                <a class=" fs-5 fw-bolder text-gray-900 text-hover-primary mb-2" data-bs-toggle="tab" href="#kt_tab_pane_chat_2">Emma Bold</a>
                                                <div class="fw-bold text-muted">emma@intenso.com</div>
                                            </div>
                                            <!--end::Details-->
                                        </div>
