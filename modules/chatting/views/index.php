...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="container-xxl" id="kt_content_container">
                    ...
                    <div class="card-header pt-7" id="kt_chat_contacts_header">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="tabcontent" id="grup" style="display: none">
                                <button type="button" class="btn btn-sm btn-light-primary ms-1 " data-bs-toggle="modal" data-bs-target="#kt_modal_users_search_grup">
                                    <span class="svg-icon svg-icon-1 me-0 text-center">
                                        <i class="fa-duotone fa-address-book" style="font-size: 30px;"></i>
                                    </span>
                                </button>
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                        <!--begin::Content-->
                        <div class="text-center mb-13">
                            <h1 class="mb-3">Search Contact</h1>
        ...
        <div class="modal fade" id="kt_modal_users_search_grup" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
