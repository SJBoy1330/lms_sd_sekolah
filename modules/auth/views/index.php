...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(<?= base_url(); ?>assets/media/illustrations/sigma-1/14.png">
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
            <!--begin::Logo-->
            <a href="../../demo17/dist/index.html" class="mb-12">
            ...
            <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                ...
                <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-lg form-control-solid" type="text" name="kode_sekolah" autocomplete="off" />
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    ...
                    <div class="text-center">
                        <!--begin::Submit button kt_sign_in_submit-->
