            ...
            <div class="row">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row" id="req_bidang_tugas">
                        ...
                        <div class="position-relative d-flex align-items-center">
                            <div style="width:100vw;">
                                <select class="form-select form-select-solid load_select1" data-control="select2" data-placeholder="Pilih Bidang Tugas" name="bidang_tugas">
                ...
                <div class="col-6">
                    <div class="d-flex flex-column mb-8 fv-row" id="req_gender">
                        ...
                        <div class="position-relative d-flex align-items-center">
                            <div style="width:100vw;">
                                <select class="form-select form-select-solid load_select2" data-control="select2" data-placeholder="Jenis Kelamin" name="gender">
                                    <option disabled></option>
                ...
                <div class="col-6">
                    <div class="d-flex flex-column mb-8 fv-row" id="req_tipe">
                        ...
                        <div class="position-relative d-flex align-items-center">
                            <div style="width:100vw;">
                                <select class="form-select form-select-solid load_select3" data-control="select2" data-placeholder="Pilih Role" name="tipe">
                                    <option disabled></option>
                ...
                <div class="col-6">
                    <div class="d-flex flex-column mb-8 fv-row" id="req_aktif">
                        ...
                        <div class="position-relative d-flex align-items-center">
                            <div style="width:100vw;">
                                <select class="form-select form-select-solid load_select4" data-control="select2" data-placeholder="Status" name="aktif">
                                    <option disabled></option>
