            ...
            <div class="row">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row" id="req_tahun_ajaran">
                        ...
                        <div class="position-relative d-flex align-items-center">
                            <div style="width:100vw;">
                                <select class="form-select form-select-solid load_select" data-control="select2" data-placeholder="Pilih" name="tahun_ajaran">
                                    <option></option>
                ...
                <div class="col-xl-4 col-md-12">
                    <div class="d-flex flex-column mb-8 fv-row" id="req_tingkat">
                        ...
                        <div class="position-relative d-flex align-items-center">
                            <div style="width:100vw;">
                                <select class="form-select form-select-solid load_select" data-control="select2" data-placeholder="Pilih" name="tingkat">
                                    <option></option>
                ...
                <div class="col-xl-4 col-md-12">
                    <div class="d-flex flex-column mb-8 fv-row" id="req_wali_kelas">
                        ...
                        <div class="position-relative d-flex align-items-center">
                            <div style="width:100vw;">
                                <select class="form-select form-select-solid load_select" data-control="select2" data-placeholder="Pilih" name="wali_kelas">
                                    <option></option>
