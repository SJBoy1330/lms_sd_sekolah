                    ...
                    <form action="">
                        <div class="row d-flex justify-content-end">
                            <div class="col-md-6 col-xl-6 align-self-end text-end" style="padding:5px; margin-top:7px;">
                                <button type="button" class="btn btn-light-success" data-bs-toggle="modal" data-bs-target="#modalTambahSiswa">
                                <span class="svg-icon svg-icon-2 me-0">
                                    <i class="fa-duotone fa-graduation-cap" style="font-size: 20px;"></i>
                                </span>
                                Siswa</button>
