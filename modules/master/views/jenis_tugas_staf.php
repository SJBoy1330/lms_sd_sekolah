                        ...
                        <div class="modal-dialog modal-dialog-centered mw-850px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bolder">Tambah Jenis Tugas Staf</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
												...
												<div class="position-relative d-flex align-items-center">
													<div style="width:100vw;">
                                                        <select class="form-select form-select-solid" data-control="select2"  data-placeholder="Pilih">
                                                            ...
                                                            <option value="2">Jabatan 3</option>
                                                        </select>
                                                    </div>
												</div>
											</div>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex flex-column mb-8 fv-row">
                                                ...
                                                <div class="position-relative d-flex align-items-center">
                                                    ...
                                                    <input class="form-control form-control-solid ps-12" placeholder="Masukkan nama jenis tugas staf" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <form action="">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-6 align-self-end text-end" style="padding:5px; margin-top:7px;">
                                <button type="button" class="btn btn-light-success" data-bs-toggle="modal" data-bs-target="#modalTambahPelajaran">
                                <span class="svg-icon svg-icon-2 me-0">
                                    <i class="fa-duotone fa-bars-progress" style="font-size: 20px;"></i>
                                </span>
