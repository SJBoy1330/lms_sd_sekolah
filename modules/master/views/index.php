            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar ">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" class="btn btn-sm btn-light-danger me-2 px-4" id="deleteall" style="display: none;">
                            <span class="svg-icon svg-icon-2 me-0">
                                <i class="fa-duotone fa-trash" style="font-size: 18px;"></i>
                            </span>
                            Hapus</button>
                        <button type="button" class="btn btn-sm btn-light-success me-2 btn-tambah-edit-modal px-4" data-bs-toggle="modal" data-bs-target="#modalTambahStaf">
                            <span class="svg-icon svg-icon-2 me-0">
                                <i class="fa-duotone fa-plus" style="font-size: 18px;"></i>
                            </span>
                            Staf</button>

                        <button type="button" class="btn btn-sm btn-light-info me-2 px-4" data-bs-toggle="modal" data-bs-target="#modalUnggah">
                            <span class="svg-icon svg-icon-2 me-0">
                                    ...
                                    <tr class="anim-1" style="opacity: 0;">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-secondary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a data-bs-toggle="modal" data-idstaf="<?= $staf->id_staf ?>" href="#modalDetail" role="button" class="menu-link px-3 detail-staf-btn">Detail</a>
                                                </div>
                                                <div class="menu-item px-3">
...
<div class="modal fade" id="modalTambahStaf" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px" id="content-edit-tambah">
    </div>
    <!--end::Modal dialog-->
</div>