                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 DataTable no-footer" id="kt_table_guru">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            <tr class="anim-2" style="opacity: 0;">
                                ...
                                <td>
                                    <p class="d-flex align-items-center text-center py-2">
                ...
                <form id="kt_inbox_reply_form">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="d-block">
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <div class="position-relative d-flex align-items-center">
                                        ...
                                        <input type="text" class="form-control form-control-solid ps-12" name="compose_to"  data-kt-inbox-form="tagify" />
                                    </div>
                                    <div class="ms-auto w-75px text-end">
                                        <span class="d-none text-muted fs-bold cursor-pointer text-hover-primary me-2" data-kt-inbox-form="cc_button">Cc</span>
                            ...
                            <!--end::Body-->
                            <!--begin::Footer-->
                            <div class="d-flex flex-stack flex-wrap gap-2 py-5 ps-8 pe-5 border-top d-none">
                                <!--begin::Actions-->
