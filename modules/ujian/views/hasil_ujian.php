        ...
        <div class="card">
            <div class="card-body border">
                <div class="row">
                    ...
                    <div class="col-md-8 col-xl-8 align-self-end" style="padding:5px;">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 DataTable no-footer">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-175px text-center">Nilai</th>
                                    <th class="min-w-175px text-center">Detail</th>
                                </tr>
                                <!--end::Table row-->
                            </thead>
                            <!--end::Table head-->
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-center">
                                            <a href="<?= base_url('ujian/detail_hasil_ujian');?>" type="button" class="btn btn-sm btn-light">
                                                <span class="svg-icon svg-icon-2 me-0">
                                                    <i class="fa-duotone fa-eye" style="font-size: 18px;"></i>
                                                </span>
                                                Serahkan
                                            </a>
                                        </p>
