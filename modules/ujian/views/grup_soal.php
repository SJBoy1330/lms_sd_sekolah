            ...
            <div class="modal-body scroll-y mx-10 my-2">
                ...
                <div class="pilgan">
                    <!-- Keterangan Tipe Soal -->
                        <p> <strong class="text-success">Pilihan Ganda</strong></p>
                    <!-- Akhir keterangan tipe soal -->
                    ...
                    <!-- Inputan untuk mengisi soal -->
                        <div class="row">
                            ...
                            <div class="col-3 d-flex justify-content-center align-items-center">
                                ...
                                <!-- Option Tipe Soal -->
                                    <div class="audio">
                                        <button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" style="min-height : 40px; min-width: 40px">
                                            <i class="fa-duotone fa-ellipsis"  style="font-size: 1.5rem;"></i>
                                        </button>
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true" style="">
                                            <div class="menu-item px-3">
                                                <div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase text-start">Tipe Soal
                                                </div>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a class="menu-link px-3">Pilihan Ganda</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a class="menu-link px-3">Pilihan Ganda Komplex</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a class="menu-link px-3">Uraian Singkat</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a class="menu-link px-3">Uraian Panjang</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a class="menu-link px-3">Penjodohan</a>
                                            </div>
                                        </div>
                                    </div>
                            </div>
