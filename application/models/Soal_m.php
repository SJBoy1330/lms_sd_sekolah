...
class Soal_m extends MY_Model{
	...
	public function get_single_soal($array=NULL){
		$query = parent::get_single($array);
		return $query;
	}

	public function get_soal($array=NULL, $limit=20, $start=0){
		$query = parent::get_order_by($array, $limit, $start);
		return $query;
	}
	public function get_soal_all($array=NULL){
		$query = parent::get_all($array);
		return $query;
	}

	public function insert_soal($array){
		$id=parent::insert($array);
		return $id;
	}

	public function update_soal($data, $id=NULL){
